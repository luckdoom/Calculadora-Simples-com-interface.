...
class tela():
    def __init__(self):
        ...
        self.auxBt0.set(0)
        self.bt01=tk.Button(self.tela,textvariable=self.auxBt0,width=self.WIDTH,height=self.HEIGHT,font=self.Fonte,command=lambda :atualizar(self.auxBt0.get()))
        ...
        self.auxBt3.set(3)
        self.bt4 = tk.Button(self.tela, textvariable=self.auxBt3, width=self.WIDTH,height=self.HEIGHT,font=self.Fonte,command=lambda: atualizar(self.auxBt3.get()))
        ...
        self.auxBtMenos.set("-")
        self.btMenos = tk.Button(self.tela, textvariable=self.auxBtMenos, width=self.WIDTH, height=self.HEIGHT,font=self.Fonte, bg="light blue",command=lambda: atualizar(self.auxBtMenos.get()))
        self.btMenos.grid(row=4, column=1, padx=2, pady=2)

        # operador +
        self.auxBtMais = tk.StringVar()
        self.auxBtMais.set("+")
        self.btMais = tk.Button(self.tela, textvariable=self.auxBtMais, width=self.WIDTH, height=self.HEIGHT,font=self.Fonte,bg="light blue",command=lambda: atualizar(self.auxBtMais.get()))
        self.btMais.grid(row=4, column=2, padx=2, pady=2)

        # operador /
        self.auxBtDiv = tk.StringVar()
        self.auxBtDiv.set("/")
        self.btDiv = tk.Button(self.tela, textvariable=self.auxBtDiv, width=self.WIDTH, height=self.HEIGHT,font=self.Fonte,bg="light blue",command=lambda: atualizar(self.auxBtDiv.get()))
        self.btDiv.grid(row=5, column=0, padx=2, pady=2)

        # operador x
        self.auxBtMul = tk.StringVar()
        self.auxBtMul.set("x")
        self.btMul = tk.Button(self.tela, textvariable=self.auxBtMul, width=self.WIDTH, height=self.HEIGHT,font=self.Fonte,bg="light blue", command=lambda: atualizar(self.auxBtMul.get()))
        self.btMul.grid(row=5, column=1, padx=2, pady=2)

        # igual
        self.auxBtIgual = tk.StringVar()
        self.auxBtIgual.set("=")
        self.btIgual = tk.Button(self.tela, textvariable=self.auxBtIgual, width=self.WIDTH, height=self.HEIGHT,font=self.Fonte,bg="gray",command=lambda: calcular())
